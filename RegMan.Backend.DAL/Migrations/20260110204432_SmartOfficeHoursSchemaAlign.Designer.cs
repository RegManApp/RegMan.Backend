...
namespace RegMan.Backend.DAL.Migrations
{
    ...
    [Migration("20260110204432_SmartOfficeHoursSchemaAlign")]
    partial class SmartOfficeHoursSchemaAlign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourQrToken", b =>
                {
                    b.Property<int>("QrTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("OfficeHourCompletionQrTokenId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("QrTokenId"));

                    b.Property<Guid?>("CurrentNonce")
                    ...
                    b.Property<int>("QueueEntryId")
                        .HasColumnType("int")
                        .HasColumnName("OfficeHourQueueEntryId");
                    ...
                    b.ToTable("OfficeHourCompletionQrTokens");
                });

            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourQueueEntry", b =>
                {
                    b.Property<int>("QueueEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("SessionId")
                        .HasColumnType("int")
                        .HasColumnName("OfficeHourSessionId");
                    ...
                    b.HasIndex("SessionId", "EnqueuedAtUtc")
                    ...
                    b.ToTable("OfficeHourQueueEntries");
                });

            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourSession", b =>
                {
                    b.Property<int>("SessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("OfficeHourIdDb")
                        .HasColumnType("int")
                        .HasColumnName("OfficeHourId");
            ...
            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourQrToken", b =>
                {
                    b.HasOne("RegMan.Backend.DAL.Entities.OfficeHourQueueEntry", "QueueEntry")
                        .WithOne("QrToken")
                        .HasForeignKey("RegMan.Backend.DAL.Entities.OfficeHourQrToken", "QueueEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourQueueEntry", b =>
                {
                    b.HasOne("RegMan.Backend.DAL.Entities.OfficeHourSession", "Session")
                        .WithMany("QueueEntries")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RegMan.Backend.DAL.Entities.BaseUser", "StudentUser")
                        .WithMany()
