...
namespace RegMan.Backend.DAL.Migrations
{
    ...
    [Migration("20260110180152_AddSmartOfficeHours")]
    partial class AddSmartOfficeHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RegMan.Backend.DAL.Entities.OfficeHourQueueEntry", b =>
                {
                    ...
                    b.Property<string>("LastStateChangedByUserId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SessionId", "StudentUserId", "IsActive")
                        .IsUnique()
