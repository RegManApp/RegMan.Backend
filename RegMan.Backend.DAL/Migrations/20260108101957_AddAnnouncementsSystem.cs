        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnnouncementRecipients_AspNetUsers_RecipientUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementRecipients_AnnouncementId_RecipientUserId",
                table: "AnnouncementRecipients",
                columns: new[] { "AnnouncementId", "RecipientUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementRecipients_RecipientUserId",
                table: "AnnouncementRecipients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_CreatedAt_IsArchived",
                table: "Announcements",
                columns: new[] { "CreatedAt", "IsArchived" });
